...
for(i in inicio:(2*njobs/4)){
  ...
  save(anom.training.gauss, file = "~/EVAChallenge2019/MarginsThresh/OutputsAllTh/anom.training.gauss_excth_2.Rdata")
  save(iter.error, file = "~/EVAChallenge2019/MarginsThresh/OutputsAllTh/iter.error_excth_2.Rdata")
  save(xi.hat, file = "~/EVAChallenge2019/MarginsThresh/OutputsAllTh/xi.hat_excth_2.Rdata")
  save(sigma.gp.hat, file = "~/EVAChallenge2019/MarginsThresh/OutputsAllTh/sigma.gp.hat_excth_2.Rdata")
  save(sigma.gev.hat, file = "~/EVAChallenge2019/MarginsThresh/OutputsAllTh/sigma.gev.hat_excth_2.Rdata")
  save(mu.gev.hat, file = "~/EVAChallenge2019/MarginsThresh/OutputsAllTh/mu.gev.hat_excmu_2.Rdata")
